package com.naver.papago.mybasicscodelab
...
import com.naver.papago.mybasicscodelab.ui.theme.MyBasicsCodeLabTheme
    ...
    Surface(
        ...
        Row(modifier = Modifier.padding(24.dp)) {
            Column(
                ...
                Text(maxLines = 1, overflow = TextOverflow.Ellipsis, text = "Hello, ellipsis test")
                Text(
                    text = name,
...
fun OnBoardingScreen(onContinueClicked: () -> Unit) {
    Surface {
        Column(
            ...
            Text("Welcome to the my Basics Codelab!")
            Button(
